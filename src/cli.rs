...
"#;
  ...
  --Bdynamic                 Ignored for GCC compatibility
  --Bstatic                  Ignored for GCC compatibility
  --dynamicbase              Ignored for Rust compatibility
    --disable-dynamicbase
  --enable-auto-image-base   Ignored for Rust compatibility
    --disable-auto-image-base
  -flto                      Ignored for GCC LTO option compatibility
    -fno-lto
  --high-entropy-va          Ignored for Rust compatibility
  --major-image-version=<number>
                             Ignored for CMake compatibility
  --minor-image-version=<number>
                             Ignored for CMake compatibility
  --nxcompat                 Ignored for Rust compatibility
        ...
        while !args.is_empty() || !stack.is_empty() {
            ...
            match arg {
                ...
                argfile::Argument::Path(path) => {
                    ...
                    args.extend(argfile::parse_fromfile(&content, argfile::PREFIX));
                }
            }
        }
...
impl From<Emulation> for LinkerTargetArch {
    fn from(value: Emulation) -> Self {
        match value {
            Emulation::I386Pep => LinkerTargetArch::Amd64,
            Emulation::I386Pe => LinkerTargetArch::I386,
        }
    }
}
